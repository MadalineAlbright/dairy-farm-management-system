    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="/" class="logo">
                ...
                <span class="logo-lg">DAIRY SYSTEM</b></span>
            </a>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="dairy.png" class="" alt="dairy Image">
                    </div>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <span>Dairy Inventory</span>
                        <span class="pull-right-container">
                        </span>
                    </a>
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('/add-stock')}}"><i class="fa fa-clone"></i> Add Products</a></li>
                            <li><a href="{{URL::to('/stock-manage')}}"><i class="fa fa-leaf"></i> Manage Products</a></li>
                        </ul>
                    </li>
